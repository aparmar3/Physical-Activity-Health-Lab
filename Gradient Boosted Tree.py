...
hip_rf = GradientBoostingClassifier(n_estimators = 200)
...
# Import the model we are using
# Instantiate model with 1000 decision trees
wrist_rf = GradientBoostingClassifier(n_estimators = 200)
print("done instantiating model")
# Train the model on training data
...
hip_and_wrist_rf = GradientBoostingClassifier(n_estimators = 200)
print("done instantiating model")
# parameters = {
#     'n_estimators': [600, 800, 1000],
#     }
#
# clf = GridSearchCV(hip_and_wrist_rf, parameters, cv=3, verbose=1,n_jobs=-1)
